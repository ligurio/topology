...
-- not the first time.
--
test_run:cmd("create server storage_1_1 with script='vshard/storage_1_1.lua'")
...
test_run:cmd("create server storage_1_2 with script='vshard/storage_1_2.lua'")
...
test_run:cmd("create server storage_1_3 with script='vshard/storage_1_3.lua'")
